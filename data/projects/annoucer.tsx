...
//LINK data/projects/annoucer.tsx
...
const project: Project = {
  id: "annoucer",
  name: {
    en: "Twitch + Discord platform",
    fr: "Plateforme Twitch + Discord",
  },
  description: {
    en: "DocAutomatic STREAMS TWITCH STREAMS, IA messages generation and sending to Discord via webhook. Oauth, Admin Panel, and Webhook Manager included.",
    fr: "Surveillance automatique des streams Twitch d'amis, génération de messages IA et envoi dans Discord via webhook. OAuth, admin panel, et webhook manager inclus.",
  },
  image: {
    src: "/images/annoucer.png",
    alt: {
      "en": "Twitch + Discord platform",
      "fr": "Plateforme Twitch + Discord"
    }
